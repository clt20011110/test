...
renderInfo state =
    div
        ...
        [ Markdown.toHtml [] """
elm-pentis is a Pentis game coded in [**Elm**](http://elm-lang.org/) language.
...
elm-pentis is a modified version of [**elm-flatris**](https://github.com/w0rm/elm-flatris). Beyond being ported to Elm 0.19.1, the code was cleaned up, and adjusted to fit SilverFOCS needs.
"""
        ]
